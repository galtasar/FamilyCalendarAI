...
public class AiAnalysisResult
{
    ...
    [JsonPropertyName("events")] public List<AiEventDraft> Events { get; set; } = [];
}

public class AiEventDraft
{
    [JsonPropertyName("action")] public string Action { get; set; } = "create";
    [JsonPropertyName("family_members")] public List<string> FamilyMembers { get; set; } = [];
